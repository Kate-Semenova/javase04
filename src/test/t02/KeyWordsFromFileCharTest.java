 ...
 */
public class KeyWordsFromFileCharTest {
    private static final Integer NUMBER = 1;

    @Test
    @DisplayName("getKeyWords() returns Map<String, Integer>")
    void getKeyWordsShouldReturnMap() {
        KeyWordsFromFileByte keyWordsFromFileChar = new KeyWordsFromFileByte(new File("src\\test\\filetest\\test"));
        ...
        map.put("null", NUMBER);
        assertEquals(map, keyWordsFromFileChar.getKeyWords());
    }
}
